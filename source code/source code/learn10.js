...
let skeleton;
let thirtysecs;
let posesArray = ['stand relaxed, for 10 secs', 'Vrikshasana', 'Bititlasana', 'Virbhadrasana I', 'Virbhadrasana II', 'Utkatasana'];
...
function setup() {
  ...
  imgArray[0].src = 'imgs/stand.jpg';
  imgArray[1] = new Image();
  imgArray[1].src = 'imgs/vrikshasan.jpg';
  imgArray[2] = new Image();
  imgArray[2].src = 'imgs/bitilasan.jpg';
  imgArray[3] = new Image();
  imgArray[3].src = 'imgs/virbhadrasan1.jpg';
  imgArray[4] = new Image();
  imgArray[4].src = 'imgs/virbhadrasan2.jpg';
  imgArray[5] = new Image();
  imgArray[5].src = 'imgs/utkatasana.jpg';
